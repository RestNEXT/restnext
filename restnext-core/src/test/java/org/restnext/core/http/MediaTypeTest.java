...
public class MediaTypeTest {
    ...
    @Test(expected = RuntimeException.class) public void testInvalidParse() throws Exception {
        assertInvalid("");
        assertInvalid("/");
        assertInvalid("/");
        assertInvalid("text");
    ...
    @Test public void testDefaultCharset() throws Exception {
        ...
        assertEquals("UTF-8", noCharset.charset(StandardCharsets.UTF_8).name());
        ...
        assertEquals("ISO-8859-1", charset.charset(StandardCharsets.UTF_8).name());
