...
public abstract class AbstractMultivaluedMap<K, V> implements MultivaluedMap<K, V> {
   ...
   * implementation.
   *
   * @param store the backing {@link Map} to be used as a [key, multi-value] store. Must not be
   *              {@code null}.
   ...
   *
   * <p>NOTE: This implementation ignores {@code null} values; A supplied value
   ...
   * is {@code null}.
   *
   * <p>NOTE: This implementation ignores {@code null} values; Any of the supplied values
   * of {@code null} is ignored and not added to the value list. Overriding
   * implementations may modify this behavior by redefining the
   * {@link #addNull(java.util.List)} method.
   *
   ...
   *
   * <p>NOTE: This implementation ignores {@code null} values; Any {@code null} value
   ...
   * in the value list.
   *
   * <p>Default implementation is a no-op, i.e. the {@code null} values are ignored.
   ...
   * empty.
   *
   * <p>If there is no entry for the key in the map, a new empty {@link List}
   * instance is created, registered within the map to hold the values of
   * the key and returned from the method.
   *
   * @param key the key.
   * @return value list registered with the key. The method is guaranteed to never return {@code
   * null}.
   */
   ...
   * {@inheritDoc }
   *
   * <p>This implementation delegates the method call to to the the underlying
   ...
   * [key, multi-value] store.
   *
   * @return {@code true} if the specified object is equal to the underlying [key, multi-value]
