...
public class EntityTag {
     ...
     * <p>
     * Note that this type cannot be used to create request header values for
     ...
     * @throws NullPointerException if the supplied string cannot be parsed
     *                              or is {@code null}.
     */
    public static EntityTag fromString(String value) {
        ...
        if (!isQuoted && !isAnyMatch) {
            throw new RuntimeException(String.format("header value (%s) is not a valid entity tag.", value));
        }
