...
//        if (!typeSubtype.lookingAt()) return null;
        if (!typeSubtype.lookingAt()) throw new RuntimeException(String.format("the input '%s' does not seem to be a valid media type.", string));
...
//            if (!parameter.lookingAt()) return null; // This is not a well-formed media type.
            if (!parameter.lookingAt()) throw new RuntimeException(String.format("'%s' is not a well-formed media type.", string)); // This is not a well-formed media type.
